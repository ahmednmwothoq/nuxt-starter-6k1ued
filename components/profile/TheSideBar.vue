<template>
  <div class="sidebar-content">
    <ul class="list-style">
      ...
      <li class="list">
        <nuxt-link :to="localePath('/profile/custom-order')" class="list-link">
    ...
    <button @click.prevent="logout" class="profile-side-btn" v-if="!isLoading">LOGOUT</button>
