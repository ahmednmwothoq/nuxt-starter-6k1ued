      ...
      <div class="row">
        <div class="col-lg-4 col-md-4">
          <div class="footer-box">
            ...
            <div class="content">
              <p class="title">24/7 HOUR SUPPORT</p>
              <p class="sub-title">Our online support section is available and regularly updated if you'd prefer.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-4">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="bottom-box">
              <ul class="list-style">
                <li class="list">
                  <nuxt-link :to="localePath('/about')" class="list-link">About Us</nuxt-link>
                </li>
                <li class="list">
                  <nuxt-link :to="localePath('/terms')" class="list-link">Terms & Conditions</nuxt-link>
                </li>
                <li class="list">
                  <nuxt-link :to="localePath('/contact')" class="list-link">Contact Us</nuxt-link>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="bottom-box bottom-box-right">
              <div class="content">
                <a href="#" class="store-link">
                  <img src="~/assets/images/icons/google_play.svg" alt="google_play">
                </a>
                <a href="#" class="store-link">
                  <img src="~/assets/images/icons/app_store.svg" alt="app_store">
                </a>
              </div>
            </div>
          </div>
