<template>
  <div class="auth-page">
    <the-header-page :title="availableLocales ? `تسجيل الدخول كمورد` : `Login As Supplier`"/>
      ...
      <div class="row">
        <div class="col-lg-6 pt-5 mb-3">
          <div class="auth-content">
            ...
            <nuxt-link :to="localePath('/auth/login')">{{availableLocales ? `تسجيل الدخول كمستخدم` : `Login As User`}}</nuxt-link>
            </p>
          </div>
        </div>
        <div class="col-lg-6 pt-5 mb-3">
